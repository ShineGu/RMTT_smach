...
sys.path.append("/home/shine/PythonRobotics/PathPlanning/CubicSpline/")
sys.path.append("/home/shine/PythonRobotics/PathPlanning/PotentialFieldPlanning")
...
if __name__ == '__main__':
    ...
    sub = rospy.Subscriber('/new_pose', PoseStamped, callback, queue_size=10)
    pub = rospy.Publisher('/cmd_vel_traj', Twist, queue_size=10)
    rospy.spin()
